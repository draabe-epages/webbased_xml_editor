...
(function (root, factory) {
  ...
  Raphael.fn.inlineTextEditing = function(subject, options, callback) {
    ...
    // Store instance of the Raphael r
    var r = this;
    ...
    subject.inlineTextEditing = {
      ...
      startEditing: function(){
        ...
        var container      = this.r.canvas.parentNode;
        var translateX      = 0;
        var translateY      = 0;
        var transformOrder  = {};
       ...
       */
      stopEditing: function(node, arr){

        // Set the new the value
        subject.attr("text", this.input.value);

        //NodeLabel muss ebenfalls geändert werden
        node.label = this.input.value;
        //Prüfen auf ungültige Zeichen
        if(this.validString(node.label) == true){
